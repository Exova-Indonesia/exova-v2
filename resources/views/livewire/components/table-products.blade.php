                ...
                <div class="mx-auto container bg-white dark:bg-gray-800 dark:bg-gray-800 shadow rounded">
                    <div class="flex flex-col lg:flex-row p-4 lg:p-8 justify-between items-start lg:items-stretch w-full">
                        ...
                        <div class="w-full lg:w-2/3 flex flex-col lg:flex-row items-start lg:items-center justify-end">
                            ...
                            <div class="lg:ml-6 flex items-center">
                                <x-jet-button class="ml-2 bg-blue-500 hover:bg-blue-600 focus:border-blue-300 active:bg-blue-900" >
                                    {{ __('Download') }}
                                </x-jet-button>
                            ...
                            <tbody>
                                <tr class="h-24 border-gray-300 border-b">
                                    <td class="pl-8 pr-6 text-left whitespace-no-wrap text-sm text-gray-800 dark:text-gray-100 tracking-normal leading-4">
                                        <input wire:model="selectedProducts" value="1" type="checkbox" class="cursor-pointer relative w-5 h-5 border rounded border-gray-400 bg-white dark:bg-gray-800 focus:outline-none focus:outline-none focus:ring-2  focus:ring-gray-400" />
                                    </td>
                  ...
                  Active
                                    ...
                                    <td class="pr-8 relative">
                                        <button wire:click="dropDown" aria-label="dropdown" role="button" class="dropbtn text-gray-500 rounded cursor-pointer border border-transparent  focus:outline-none focus:ring-2 focus:ring-offset-2  focus:ring-gray-400">
