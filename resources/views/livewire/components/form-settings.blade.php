<div>
            ...
            <div class="container mx-auto bg-white dark:bg-gray-800 shadow rounded">
                <form id="form">
                    <div class="container mx-auto bg-white dark:bg-gray-800 py-6 w-11/12">
                        ...
                        <div class="flex justify-between items-center mb-8">
                            ...
                            <div class="cursor-pointer rounded-full relative shadow-sm">
                                <input role="checkbox" aria-label="Get notified when a post or comment is made" type="checkbox" name="email_comments" id="toggle1" class="focus:outline-none checkbox w-4 h-4 rounded-full bg-white absolute m-1 shadow-sm appearance-none cursor-pointer" />
                        ...
                        <div class="flex justify-between items-center mb-8">
                            ...
                            <div class="cursor-pointer rounded-full relative shadow-sm">
                                <input role="checkbox" aria-label="Get notified when a candidate applies to a job posting" type="checkbox" name="email_job_application" id="toggle2" class="focus:outline-none checkbox w-4 h-4 rounded-full bg-white absolute m-1 shadow-sm appearance-none cursor-pointer" />
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <div class="cursor-pointer rounded-full relative shadow-sm">
                                <input role="checkbox" aria-label="Get notifitied when there is a new product feature or upgrade" type="checkbox" name="email_product_update" id="toggle3" class="focus:outline-none checkbox w-4 h-4 rounded-full bg-white absolute m-1 shadow-sm appearance-none cursor-pointer" />
                        ...
                        <div class="flex justify-between items-center mb-8">
                            ...
                            <div class="cursor-pointer rounded-full relative shadow-sm">
                                <input role="checkbox" aria-label="Get notified when a post or comment is made" type="checkbox" name="notification_comment" id="toggle4" class="focus:outline-none checkbox w-4 h-4 rounded-full bg-white absolute m-1 shadow-sm appearance-none cursor-pointer" />
                        ...
                        <div class="flex justify-between items-center mb-8">
                            ...
                            <div class="cursor-pointer rounded-full relative shadow-sm">
                                <input role="checkbox" aria-label="Get notified when a candidate applies to a job posting" type="checkbox" name="notification_application" id="toggle5" class="focus:outline-none checkbox w-4 h-4 rounded-full bg-white absolute m-1 shadow-sm appearance-none cursor-pointer" />
                        ...
                        <div class="flex justify-between items-center mb-8">
                            ...
                            <div class="cursor-pointer rounded-full relative shadow-sm">
                                <input role="checkbox" aria-label="Get notifitied when there is a new product feature or upgrades" type="checkbox" name="notification_updates" id="toggle6" class="focus:outline-none checkbox w-4 h-4 rounded-full bg-white absolute m-1 shadow-sm appearance-none cursor-pointer" />
