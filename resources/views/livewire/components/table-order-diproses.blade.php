   ...
   <div class="w-full">
      <div class="px-4 md:px-10 py-4 md:py-7 bg-gray-100 rounded-tl-lg rounded-tr-lg">
         <div class="sm:flex items-center justify-between">
            <p tabindex="0" class="focus:outline-none text-base sm:text-lg md:text-xl lg:text-2xl font-bold leading-normal text-gray-800">Kontrak Dimulai</p>
         </div>
      </div>
        ...
        <table class="w-full whitespace-nowrap">
            <thead>
               <tr tabindex="0" class="focus:outline-none h-16 w-full text-sm leading-none text-gray-800">
                  ...
                  <th class="font-normal text-left pl-20">Fix Price</th>
                  <th class="font-normal text-left pl-20">Deadline</th>
                  <th class="font-normal text-left pl-20">Deal At</th>
               </tr>
            </thead>
            <tbody class="w-full">
                ...
                <tr wire:click="openProject(`{{ $item['uuid'] }}`)" tabindex="0" class="focus:outline-none h-20 text-sm leading-none text-gray-800 bg-white hover:bg-gray-100 border-b border-t border-gray-100">
                   ...
                   <td class="pl-20">
                      <p class="font-medium">{{ number_format($item['deal_price'], 0, ',', '.') }}</p>
                   </td>
                   <td class="pl-20">
                      <p class="font-medium">{{ $item['requests']['due_at']->format('F j, Y h:i a') }}</p>
                   </td>
                   <td class="pl-20">
                      <p class="font-medium">{{ $item['start_at']->format('F j, Y h:i a') }}</p>
                   </td>
                </tr>
                @endforeach
