...
<div class="w-full lg:w-2/5 border-r">
      ...
      <div class="flex items-start">
        ...
        <div class="w-full flex-col md:flex-row justify-center flex pt-12">
          <div class="flex items-center justify-center xl:justify-start mt-1 md:mt-0 mb-5 md:mb-0">
              <div tabindex="0" class="focus:outline-none hover:bg-blue-200 transistion ease-in-out duration-200 hover:text-blue-900 cursor-pointer mx-2 rounded-full bg-blue-100 text-blue-700 text-sm px-6 py-2 flex justify-center items-center">Kelola Studio</div>
   ...
   <div class="px-12 border-t border-b lg:border-t-0 lg:border-b-0 border-gray-300 flex flex-col items-center py-10">
      ...
      <a tabindex="0" class="cursor-pointer  focus:opacity-75 focus:underline hover:opacity-75  focus:outline-none text-gray-800 dark:text-gray-100 text-xl tracking-normal text-center font-medium mb-1">Senior Product Designer</a>
