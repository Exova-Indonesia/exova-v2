<div>
      <div id="mobile-nav" style="min-height: 716px" class="z-30 w-64 absolute sm:relative bg-gray-900 shadow md:h-full flex-col transition ease-in-out duration-500 justify-between flex">
         <button aria-label="toggle sidebar" id="openSideBar" class="lg:hidden h-10 w-10 bg-gray-800 absolute right-0 mt-16 -mr-10 flex items-center shadow rounded-tr rounded-br justify-center cursor-pointer focus:outline-none" wire:click="sidebarHandler">
         ...
         <div class="px-8">
            ...
            <ul class="mt-12">
               <li wire:click="loadContent('dashboard')" class="flex w-full justify-between @if($title == 'dashboard') text-gray-300 @else text-gray-400 hover:text-gray-300 @endif cursor-pointer items-center mb-6">
               ...
               <li wire:click="loadContent('analytics')"  class="flex w-full justify-between  @if($title == 'analytics') text-gray-300 @else text-gray-400 hover:text-gray-300 @endif cursor-pointer items-center mb-6">
                  <a class="flex items-center focus:outline-none ">
                     <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
               ...
               <li wire:click="loadContent('achievement')"  class="flex w-full justify-between @if($title == 'achievement') text-gray-300 @else text-gray-400 hover:text-gray-300 @endif cursor-pointer items-center mb-6">
                  <a class="flex items-center focus:outline-none ">
                     <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <script>
        ...
        let toggler = document.getElementById("mobile-toggler");
        let moved = false;
    window.addEventListener("sidebarHandler", (e) => {
        if (moved) {
