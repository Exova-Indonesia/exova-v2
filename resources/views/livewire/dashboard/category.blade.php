<div>
<section id="kategori" class="bg-white rounded-4xl mb-12">
   <div class="container items-center max-w-6xl px-4 mx-auto sm:px-20 md:px-32 lg:px-16">
      ...
      <div class="text-center">
         <div class="flex flex-row flex-wrap text-center gap-1">
            @foreach ($category as $item)
            <a href="{{ url('products?filter=' . $item['id']) }}" class="cursor-pointer m-3 hover:scale-110 duration-500 transform">
