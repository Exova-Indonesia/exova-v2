...
<section id="kategori" class="bg-pink-700 py-20 rounded-4xl">
   ...
   <div id="slider" class="swiper-container container w-full">
               ...
               <div class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
                  <div class="grid gap-10 lg:grid-cols-2">
                     <div class="flex flex-col justify-center md:pr-8 xl:pr-0 lg:max-w-lg">
                        ...
                        <div>
                           <a href="/" aria-label="" class="inline-flex text-white items-center font-semibold transition-colors duration-200 text-deep-purple-accent-400 hover:text-deep-purple-800">
                              Learn more
                              <svg class="inline-block text-white w-3 ml-2" fill="currentColor" viewBox="0 0 12 12">
