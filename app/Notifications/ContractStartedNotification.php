...
class ContractStartedNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
                    ->subject('Yukk gas! Kontrak telah dimulai')
                    ->greeting('Hello Exovers!')
                    ->line('Klien baru saja membayar kontrak, sekarang kamu bisa mengerjakan projectnya')
